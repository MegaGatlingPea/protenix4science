            ...
            loss_fns.update(
                {
                    ...
                    "mse_loss": lambda: self.mse_loss(
                        # [Xujun] Start 添加condition mask
                        pred_coordinate=pred_dict["coordinate"][:, ~feat_dict['is_condition_atom'], :],
                        true_coordinate=label_dict["coordinate"][~feat_dict['is_condition_atom'], :],
                        coordinate_mask=label_dict["coordinate_mask"][~feat_dict['is_condition_atom']],
                        is_rna=feat_dict["is_rna"][~feat_dict['is_condition_atom']],
                        is_dna=feat_dict["is_dna"][~feat_dict['is_condition_atom']],
                        is_ligand=feat_dict["is_ligand"][~feat_dict['is_condition_atom']],
                        per_sample_scale=diffusion_per_sample_scale,
                    ),
                    # [Xujun] End
                }
