...
from configs.configs_user import (  # [Xujun] START 增加蛋白质主链生成的开关逻辑参数; [Xujun] END
    N_cycle, N_sample, base_dir, checkpoint_interval, data_condition,
    diffusion_batch_size, ema_decay, eval_interval, load_checkpoint_path,
    load_ema_checkpoint_path, log_interval, lr, max_steps, project, run_name,
    sample_diffusion_N_step, train_crop_size, use_wandb, warmup_steps)
# pylint: disable=C0114,C0301
from protenix.config.extend_types import (GlobalConfigValue, ListValue,
                                          RequiredValue, ValueMaybeNone)
...
basic_configs = {
    ...
    "iters_to_accumulate": 1,  # 梯度累积次数, 等价于batch_size
    "eval_only": False,
    "load_checkpoint_path": load_checkpoint_path,
    "load_ema_checkpoint_path": load_ema_checkpoint_path,
    "load_strict": False,
...
model_configs = {
    ...
    "c_s": 384,
    "c_z": 128,
    # [Xujun] START 增加mask token
    "c_s_inputs": 452,  # c_s_inputs == c_token + 35 + 32 + 1
    # [Xujun] END
    "c_atom": 128,
    "c_atompair": 16,
    "c_token": 384,
    ...
    "no_bins": 64,
    "sigma_data": 16.0,
    "diffusion_batch_size": diffusion_batch_size,  # raw 48
    ...
    "model": {
        ...
        "N_cycle": N_cycle,  # 4 for default and 10 for inference
        "input_embedder": {
