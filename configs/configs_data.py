...
from configs.configs_user import (  # [Xujun] START 增加蛋白质主链生成的开关逻辑参数; [Xujun] END
    data_condition, data_posebusters_0925_base_info_max_n_token,
    data_test_sets, data_train_sets, num_dl_workers)
...
DATA_ROOT_DIR = "/data1/af3_design_team/protenix_data"
...
data_configs = {
    ...
    "posebusters_0925": {
        "base_info": {
            ...
            "max_n_token": data_posebusters_0925_base_info_max_n_token,  # filter data
        },
        **deepcopy(default_test_configs),
    },
    "msa": {
