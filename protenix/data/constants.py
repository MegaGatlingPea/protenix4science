...
MASK_TOKENS = {
    '-P': 31,  # protein mask token
    '-N': 32,  # nucleic acid mask token
    '-L': 33,  # ligand mask token
}

STD_RESIDUES = PRO_STD_RESIDUES | RNA_STD_RESIDUES | DNA_STD_RESIDUES | MASK_TOKENS
PROTEIN_BACKBONE_ATOM_NAMES = ['N', 'CA', 'C', 'O']
NA_BACKBONE_ATOM_NAMES = ['P', 'OP1', 'OP2', r"O5'", r"C5'", r"C4'", r"O4'", r"C3'", r"O3'", r"C1'", r"C2'", r"O2'"]
