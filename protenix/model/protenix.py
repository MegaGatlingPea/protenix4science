...
# [Xujun] Start 增加constraint模块
from .modules.embedders import ConstraintEmbedder
# [Xujun] End
...
class Protenix(nn.Module):
    ...
    def __init__(self, configs) -> None:
        ...
        # [Xujun] Start 增加constraint模块
        if self.configs.data_condition in ['all', 'constraint']:
    ...
    def forward(
        ...
        if mode == "train":
            ...
            if label_dict is not None:
                ...
                ), print(f'{label_dict["coordinate"].size()} != {label_full_dict["coordinate"].size()}')
